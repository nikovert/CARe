...
def dreal_triple_integrator_BRS(dreal_partials, dreal_variables, epsilon=0.5, 
                              reachMode='forward', reachAim='reach', 
                              setType='set', save_directory="./"):
    """Verifies if the HJB equation holds using dReal for triple integrator."""
    
    # Extract variables
    t = dreal_variables["x_1_1"]
    x_1 = dreal_variables["x_1_2"]  # Position
    x_2 = dreal_variables["x_1_3"]  # Velocity
    x_3 = dreal_variables["x_1_4"]  # Acceleration
